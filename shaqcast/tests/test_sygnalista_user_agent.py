...
def test_sygnalista_user_agent_format() -> None:
    assert sygnalista_gui._sygnalista_user_agent("shaqcast", "0.1.5") == "shaqcast/0.1.5 (sygnalista)"
    assert sygnalista_gui._sygnalista_user_agent("shaqcast", None) == "shaqcast (sygnalista)"
